    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('register.clientdata')}}" method="POST" enctype='multipart/form-data'>
                        @csrf
                        ...
                        <div class="form-group row mb-3" id="form-group-dob-field">
                            ...
                            <div class="col-sm-8">
                                ...
                                {{-- <div>@error('date_of_birth')<span class="text-danger error">{{$message}}</span>@enderror</div> --}}
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3" id="address-field">
                            <label for="address" class="col-sm-4 col-form-label">Address<span class="required">*</span></label>
                            <div class="col-sm-8">
                                <textarea class="form-control" id="address" name="address" rows="3"></textarea>
                                <div>@error('address')<span class="text-danger error">{{$message}}</span>@enderror</div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3" id="upload-id-proof-field">
                            <label class="form-label col-sm-4 col-form-label" for="customFile">Upload id proof<span class="required">*</span></label>
                            <div class="col-sm-8">
                                <input type="file" class="form-control" name="idproof" >
                                <div>@error('idproof')<span class="text-danger error">{{$message}}</span>@enderror</div>
                            </div>
                        </div>
