                ...
                <div class="row h-100 align-items-center justify-content-center">
                    <div class="col-lg-6 py-5">
                      ...
                      <!-- <label for="exampleFormControlSelect1"  class="col-sm-4">Select Lawyer</label> -->
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name='casenumber'>

                            <option value="{{$cases->case_number}}" > {{$cases->case_number}}</option>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control border-0 p-4" name="clientname"  value="{{$cases->client_name}}" required="required"  />
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control border-0 p-4"  name="lawyername" value="{{$cases->lawyer_name}}" required="required" />
                                </div>
                                <div class="form-row">
                                    <div class="col-6">
                                        <div class="form-group">
